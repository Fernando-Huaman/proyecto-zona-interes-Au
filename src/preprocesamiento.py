...
def balancear_y_dividir(df: pd.DataFrame, random_state: int = 42, ratio: str = 'auto'):
    ...
    # COPIAR SOLO Au_ppm ORIGINALES en muestras reales
    ...
    # Sintéticos quedan con Au_ppm = 0 o NaN (no importa porque no los usamos en regresión)
...
def guardar_datos_procesados(df: pd.DataFrame):
    ...
    # Eliminar la columna Unnamed: 4 si existe
...
if __name__ == "__main__":
    ...
    balancear_y_dividir(df, random_state=42, ratio='auto')
